...
[Bob] > mine
  ...
  ⛏  Mining block #2 (difficulty=4)... found nonce=23263 in 0.03s
  Block #2 mined! Hash: cb18c85e3340f29f...
[Bob] > chain
...
============================================================
    ...
    │──────────────────────────────────────────────────│
    │ Hash:      b46a4b39...3202                       │
    │ Prev Hash: 4bb0944b...1a98                       │
    │ Nonce:     69732                                 │
    │ Time:      14:15:49                              │
    │ Tx Count:  2                                     │
    │──────────────────────────────────────────────────│
    │ COINBASE → Alice: 6.25 BTC                       │
    │ Alice → Bob: 3.0 BTC                             │
    +──────────────────────────────────────────────────+
                             │
                             │
    ...
    │──────────────────────────────────────────────────│
    │ Hash:      cb18c85e...9d59                       │
    │ Prev Hash: b46a4b39...3202                       │
    │ Nonce:     23263                                 │
    │ Time:      14:16:03                              │
    │ Tx Count:  2                                     │
    │──────────────────────────────────────────────────│
    │ COINBASE → Bob: 6.25 BTC                         │
    │ Bob → Alice: 1.0 BTC                             │
    +──────────────────────────────────────────────────+
